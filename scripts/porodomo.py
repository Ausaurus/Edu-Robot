...
class PomodoroTimer:
    def __init__(self):
        ...
        pygame.init()
        self.mp3_file_break = "/home/tey/catkin_ws/src/edu_robot/audio/timer.mp3"
        self.mp3_file_session = "/home/tey/catkin_ws/src/edu_robot/audio/timer.mp3"
    ...
    def update_loops(self, msg):
        ...
        self.completed_loops = 0
        self.loops_remaining_pub.publish(self.total_loops) 
    ...
    def complete_cycle(self):
        if self.current_cycle == "work":
            ...
            self.play_mp3(self.mp3_file_break) 
        else:
            self.completed_loops += 1
            remaining_loops = self.total_loops - self.completed_loops
            self.loops_remaining_pub.publish(remaining_loops) 
    ...
    def notify_completion(self):
        ...
        self.play_mp3(self.mp3_file_session) 
